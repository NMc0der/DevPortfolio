  ...
  return (
    <div className="flex flex-col md:items-start sm:items-center md:text-left sm:text-center">
      ...
      <p className="text-white">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea esse commodi
        doloribus dolore? Nisi, accusantium quisquam quae nam rem culpa maiores
        sequi! Vitae aut excepturi deleniti quibusdam optio, fuga eius!
      </p>
